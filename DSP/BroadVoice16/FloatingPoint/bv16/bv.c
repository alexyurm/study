...
int   main(int argc, char **argv)
{
   ...
   if (enc){
#if G192BITSTREAM
      fprintf(stderr," BroadVoice16 Floating-Point Encoder V1.1 with ITU-T G.192\n");
#else
      fprintf(stderr," BroadVoice16 Floating-Point Encoder V1.1 with packed bit-stream\n");
#endif
...
#if G192BITSTREAM
      fprintf(stderr," BroadVoice16 Floating-Point Decoder V1.1 with ITU-T G.192\n");
#else
      fprintf(stderr," BroadVoice16 Floating-Point Decoder V1.1 with packed bit-stream\n");
#endif
