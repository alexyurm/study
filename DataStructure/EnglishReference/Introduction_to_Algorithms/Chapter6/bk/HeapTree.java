...
//  Change the implementation from int to generics
//
class HeapTree<E extends Comparable<? super E>> {
   
   private E[] A;          //the heap array.
   ...
   void maxheapify2(int i) {
      ...
      do {
         ...
         if (l != -1) {
            ...
            if(l <= heapSize && A[l].compareTo(A[current]) > 0) {
               largest = l;
            }
         }
