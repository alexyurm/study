<?php
        ...
        isset($message) )
    {
        ...
        <html>
        <head>
        <title>OptimizeLive Demo</title>
        </head>
        <body bgcolor='LIGHTBLUE'>
            <h2>Advertising Statistcs Tool</h2>
            <?php
            ...
            ?>
            (if you've not logged in before, talk to Predictify CEO!)
    ...
    else
    {
        ...
        {
            $message = "Oh, man! Our database doesn't have your record!";
            header("Location: index.php?message=" . urlencode($message));
        }
        else
        {
